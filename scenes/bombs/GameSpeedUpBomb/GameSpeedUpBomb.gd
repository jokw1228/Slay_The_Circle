...
static func create(position_to_set: Vector2, warning_time_to_set: float, bomb_time_to_set: float, game_speed_up_value_to_set: float) -> GameSpeedUpBomb:
	return GameSpeedUpBomb_creator.create(position_to_set, warning_time_to_set, bomb_time_to_set, game_speed_up_value_to_set)
...
func exploded():
	SoundManager.play("sfx_SU_bomb","explosion")
	super()
