...
func _ready():
	...
	create_numeric_bomb(Vector2(-120, 0), 3, 6 ,1)
	create_numeric_bomb(Vector2(40, 0), 3, 6, 2)
	create_numeric_bomb(Vector2(-40, 0), 3, 6, 3)
	create_numeric_bomb(Vector2(120, 0), 3, 6, 4)
	await get_tree().create_timer(6).timeout
